	 ...
	 function arisa_child_enqueue_styles() {
		   ...
		   add_action( 'wp_enqueue_scripts', 'wiio_child_theme_style' );
				...
				function wiio_child_theme_style() {
					...
					wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css');
					wp_enqueue_style( 'child-style', get_stylesheet_directory_uri() . '/css/style.css', time(),time() );
...
?>
    ...
    function after_task_post_created( $post_id ) {
        global $wpdb;
	$table_name = $wpdb->prefix . "ig_contacts";
     ...
     // if (!empty($results)) {
       ...
       return;
        ...
        $title =get_the_title($post_id);
          $to = 'devuthopian@gmail.com';
            $yoursubject =$title;
           $headers  = 'MIME-Version: 1.0' . "\r\n";
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
            $headers .= 'From: '.$from."\r\n". 'Reply-To: '.$from."\r\n" .'X-Mailer: PHP/' . phpversion();
            $yourmessage = "";
           // $yourmessage .= "<h1>".$title."</h1>;
            $message = '<html><body>';
                  
                  $message .= ' <div class="email-main" style="background-color: #f7f7f7;">
	<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;" class="email-container">
	   <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;"><tbody><tr><td class="logo" style="padding: 1em 2.5em; text-align: center;">
	               <h1 style="margin:0;padding:0;"><a href="#" style="text-decoration: none;"><img src="https://www.wiio.io/wp-content/uploads/2022/05/Icon_Logo.png" alt="Logo"></a></h1>';
                  $message .= ' </td> </tr>';
                  $message .= ' <tr>
	            <td valign="middle">
	               <table cellspacing="0" cellpadding="0" border="0" width="100%">
	                  <tbody>
	                     <tr>
	                        <td>
	                           <div class="text" style="padding: 0 30px; color: #000000;text-align:left;">
	                              <h2 style="margin:0;padding:0;"><a href="#" style="color: #000000;text-decoration: none;">'.$title.'</a></h2>
	                              <p style="margin:0;padding:0;color:#ffffff;">&nbsp;</p>
	                              <p style="margin:0;padding:0;color: #000000; line-height:1.4; font-size: 16px;">'.$content.'</p>
	                              <p style="margin:0;padding:0;color:#ffffff;">&nbsp;</p>
	                              <p style="margin:0;padding:0;color:#ffffff;">&nbsp;</p>';
                  $message .= ' </div>
	                        </td>
                  ...
                  $message .= '  <tr>
	            <td valign="middle" class="fearured-image">
	               <table cellspacing="0" cellpadding="0" border="0" width="100%">
	                  <tbody>
	                     <tr>
                            <td class="img">
                                <img src="'.$image[0].'" width="600" height="" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto; margin: auto; display: block;" class="g-img">';
                  $message .= '</td>
                         </tr>
	                  </tbody>
	               </table>
	      ...
	      <tbody>
	         <tr>
	            <td valign="middle" class="email-footer" style="background-color: #1A1136;">
	               <table>
	                  <tbody>
	                     <tr>
	                        <td valign="top" width="100%">
	                           <table cellspacing="0" cellpadding="0" border="0" width="100%">
	                              <tbody>
	                                 <tr>
	                                    <td style="text-align: center; padding-left: 30px; padding-right: 30px;color:#ffffff;line-height: 1.4;">
	                                    	<p style="margin:0;padding:0;color:#ffffff; line-height: 1.4;">&nbsp;</p>
	                                    	<p style="margin:0;padding:0;color:#ffffff; line-height: 1.4;font-size:16px;">3rd Floor, Building 4, Qianglin Yuntong Warehouse Park, No. 22 Street, Qiantang New District, Hangzhou, China</p>
	                                    	<p style="margin:0;padding:0;color:#ffffff; line-height: 1.4;">&nbsp;</p>';
                  $message .= '</td>
	                                 </tr>
	                              </tbody>
           ...
           //  $yourmessage .= "<p>'" . $content . "' </p>";
           //  $yourmessage .= "<img src='" . $image[0] . "' >";
           
            
            // Send email.
        $adminemail = get_option( 'admin_email' );
            wp_mail(  $data, $yoursubject, $message ,$headers);
    }
